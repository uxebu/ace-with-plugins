...
Editor.prototype = {
  ...
  getCurrentCursorPosition: function () {
    var current = this._editor.session.doc.positionToIndex(this._editor.selection.getCursor());
    return current;
  },

//    editor.onCursorMove(function(pos){ console.log('new cursor position:', pos) })
  
  onCursorMove: function (callback) {
    var that = this;
    setInterval(function () {
      var currentPosition = that.getCurrentCursorPosition();
